<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Principal.aspx.cs" Inherits="Farmacia_san_juan.Principal" %>
...
<header class="cabeza">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="Principal.aspx">Farmacias San Juan</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="iniciar sesion.aspx">Iniciar sesion</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="crear_cuenta.aspx">Crear Cuenta</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex" >
          <asp:TextBox runat="server" ID="txt_buscar" CssClass="form-control me-2" TextMode="Search" pleaceholder="Buscar Producto" style="width:450px" aria-label="Search"> </asp:TextBox>
